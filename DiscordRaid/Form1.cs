...
namespace DiscordRaid
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        private void inviteButton_Click(object sender, EventArgs e)
        {
            ...
            if (channelID != "" || message != "" || invite != "")
            {
                ...
                foreach (string token in tokenList)
                {
                    ...
                    if (!response.IsSuccessful)
                    {
                        ...
                        badTokens.Add(token);
                        failedTokens += 1;
                        failedTokensTextBox.Text = "Hatalı Tokenler: " + failedTokens.ToString();
                    } else
                    {
            ...
            {
                MessageBox.Show("Sanırım biryeri boş bıraktın!");
            }
        }
        ...
        private void startSpam_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sanırım bir yeri boş bıraktın!");
            }
        }
